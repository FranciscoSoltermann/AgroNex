    ...
    return (
        <div className="flex flex-col items-center justify-center py-24 text-center animate-in fade-in duration-500">
            ...
            <p className="text-sm sm:text-base font-medium text-gray-500 dark:text-gray-400 max-w-md mx-auto leading-relaxed">
                Esta sección está en pleno desarrollo. Muy pronto vas a poder invitar colaboradores, asignar roles y controlar permisos granulares para cada miembro de tu equipo.
            </p>
