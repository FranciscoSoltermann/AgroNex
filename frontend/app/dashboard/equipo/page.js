    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-1">Gestion de Talento</p>
                    <h1 className="text-2xl font-black text-gray-900 tracking-tight">Gestion de Equipo</h1>
                    <p className="text-[13px] text-gray-500 mt-1">Administra roles, accesos y presencia de tus colaboradores en campo y almacen.</p>
                </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-[320px_1fr] gap-6">
                <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 h-fit">
                    <h2 className="text-[17px] font-black text-gray-900">Registro de Personal</h2>
                ...
                <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                    <h2 className="text-[17px] font-black text-gray-900">Colaboradores Activos</h2>
                                    ...
                                    <tr key={c.usuario} className="border-b border-gray-50">
                                        <td className="py-3">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="text-[13px] font-bold text-gray-900 leading-tight">{c.nombre}</p>
