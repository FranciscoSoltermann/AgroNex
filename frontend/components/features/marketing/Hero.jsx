      ...
      <footer className="relative z-10 pt-16 pb-12 bg-[#060D0B]/80 backdrop-blur-xl border-t border-[#52B788]/20 text-gray-300">
        <div className="container mx-auto px-6 max-w-[1400px]">
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-500 font-medium">
            <p>© 2026 AgroNex. Todos los derechos reservados. Desarrollado para la agricultura inteligente.</p>
            <div className="flex items-center gap-6">
              <span className="hover:text-gray-400 transition-colors cursor-pointer">Términos de Servicio</span>
              <span className="hover:text-gray-400 transition-colors cursor-pointer">Política de Privacidad</span>
              <span className="hover:text-gray-400 transition-colors cursor-pointer">Soporte Técnico</span>
            </div>
          </div>
        </div>
      </footer>
