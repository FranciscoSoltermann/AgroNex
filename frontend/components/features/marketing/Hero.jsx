      ...
      <section id="dashboard" className="py-16 sm:py-32 relative z-10 bg-transparent">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 max-w-[1400px]">
          ...
          <ScrollReveal delay={0.2}>
            {/* APP MOCKUP: DASHBOARD (MATCHING SCREENSHOT) */}
            <div className="bg-[#F5F7F9] rounded-[1rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] max-w-[1200px] mx-auto text-left relative overflow-hidden border border-[#52B788]/20 flex flex-col md:flex-row transform hover:-translate-y-2 transition-all duration-500 h-[600px] sm:h-[750px]">
              
              {/* Sidebar Mock */}
              <div className="hidden md:flex flex-col w-[240px] bg-[#25523b] shrink-0 text-white justify-between relative z-20 shadow-xl">
                <div className="p-5">
                  {/* Logo */}
                  <div className="flex items-center gap-3 mb-10">
                    <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
                      <Leaf className="w-5 h-5 text-[#25523b]" />
                    </div>
                    <div>
                      <div className="font-extrabold text-sm tracking-tight leading-none mb-0.5">AGRONEX</div>
                      <div className="text-[7px] text-[#A3B8B0] font-bold uppercase tracking-widest leading-none">Cultivador Digital</div>
                    </div>
                  </div>

                  {/* Menu Items */}
                  <div className="space-y-1">
                    <div className="flex items-center gap-3 px-3 py-2.5 bg-white/10 rounded-xl text-white font-bold text-xs"><LayoutDashboard className="w-4 h-4" /> Dashboard</div>
                    <div className="flex items-center gap-3 px-3 py-2.5 text-[#A3B8B0] hover:bg-white/5 hover:text-white rounded-xl font-semibold text-xs transition-colors cursor-pointer"><Map className="w-4 h-4" /> Campos/Lotes</div>
                    <div className="flex items-center gap-3 px-3 py-2.5 text-[#A3B8B0] hover:bg-white/5 hover:text-white rounded-xl font-semibold text-xs transition-colors cursor-pointer"><Sprout className="w-4 h-4" /> Campañas</div>
                    <div className="flex items-center gap-3 px-3 py-2.5 text-[#A3B8B0] hover:bg-white/5 hover:text-white rounded-xl font-semibold text-xs transition-colors cursor-pointer"><Cloud className="w-4 h-4" /> Pronósticos</div>
                    <div className="flex items-center gap-3 px-3 py-2.5 text-[#A3B8B0] hover:bg-white/5 hover:text-white rounded-xl font-semibold text-xs transition-colors cursor-pointer"><CircleDollarSign className="w-4 h-4" /> Finanzas</div>
                    <div className="flex items-center gap-3 px-3 py-2.5 text-[#A3B8B0] hover:bg-white/5 hover:text-white rounded-xl font-semibold text-xs transition-colors cursor-pointer"><Package className="w-4 h-4" /> Inventario</div>
                    <div className="flex items-center gap-3 px-3 py-2.5 text-[#A3B8B0] hover:bg-white/5 hover:text-white rounded-xl font-semibold text-xs transition-colors cursor-pointer"><Globe className="w-4 h-4" /> Ecosistema</div>
                    <div className="flex items-center gap-3 px-3 py-2.5 text-[#A3B8B0] hover:bg-white/5 hover:text-white rounded-xl font-semibold text-xs transition-colors cursor-pointer"><TrendingUp className="w-4 h-4" /> Analítica Comparativa</div>
                    <div className="flex items-center gap-3 px-3 py-2.5 text-[#A3B8B0] hover:bg-white/5 hover:text-white rounded-xl font-semibold text-xs transition-colors cursor-pointer"><Users className="w-4 h-4" /> Equipo</div>
                    <div className="flex items-center gap-3 px-3 py-2.5 text-[#A3B8B0] hover:bg-white/5 hover:text-white rounded-xl font-semibold text-xs transition-colors cursor-pointer"><Settings className="w-4 h-4" /> Ajustes</div>
                  </div>
                </div>

                {/* User */}
                <div className="flex items-center gap-3 p-5 border-t border-white/5 bg-[#1B4332]/50">
                  <div className="w-8 h-8 rounded-lg bg-[#52B788]/20 flex items-center justify-center text-sm font-bold text-white">F</div>
                  <div>
                    <div className="text-xs font-bold text-white leading-tight">francisco</div>
                    <div className="text-[9px] text-[#A3B8B0] mt-0.5">Propietario</div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 flex flex-col min-w-0 bg-[#F5F7F9]">
                ...
                <div className="bg-white px-6 py-4 flex justify-between items-center shadow-sm shrink-0">
                  <h3 className="font-extrabold text-gray-900 text-base">Resumen Operativo</h3>
                  <div className="flex items-center gap-4">
                    <Moon className="w-4 h-4 text-gray-400 cursor-pointer" />
                    ...
                    <div className="flex bg-gray-100 p-0.5 rounded-lg border border-gray-200 shadow-inner">
                      <div className="px-3 py-1 bg-[#25523b] text-white rounded text-[10px] font-bold">ARS</div>
                      <div className="px-3 py-1 text-gray-500 rounded text-[10px] font-bold cursor-pointer">USD</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex-1 p-4 sm:p-6 flex flex-col gap-4 overflow-y-auto custom-scrollbar">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 flex justify-between items-start">
                       <div>
                          <div className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-3">Total Ha</div>
                          <div className="text-4xl font-black text-gray-900 tracking-tight">0</div>
                       </div>
                       <div className="w-8 h-8 rounded-lg bg-green-50 flex items-center justify-center"><TrendingUp className="w-4 h-4 text-green-500" /></div>
                    </div>
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 flex justify-between items-start">
                       <div>
                          <div className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-3">Cantidad de Campos</div>
                          <div className="text-4xl font-black text-gray-900 tracking-tight">0</div>
                          <div className="text-[10px] text-gray-400 font-semibold mt-2">Sin campos registrados</div>
                       </div>
                       <div className="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center"><Grid className="w-4 h-4 text-blue-500" /></div>
                    </div>
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 flex justify-between items-start">
                       <div>
                          <div className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-3">Ciclos Activos</div>
                          <div className="text-4xl font-black text-gray-900 tracking-tight">0</div>
                          <div className="text-[10px] text-gray-400 font-semibold mt-2">Sin ciclos activos</div>
                       </div>
                       <div className="w-8 h-8 rounded-lg bg-teal-50 flex items-center justify-center"><RefreshCcw className="w-4 h-4 text-teal-500" /></div>
                    </div>
                  </div>

                  {/* Row 2 */}
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 min-h-[140px] flex flex-col relative overflow-hidden">
                       <div className="flex justify-between items-center mb-6 relative z-10">
                          <div className="flex items-center gap-2"><AlertTriangle className="w-4 h-4 text-orange-400" /><span className="text-sm font-bold text-gray-800">Alertas de Inventario</span></div>
                          <span className="text-[10px] text-gray-400 hover:text-green-600 font-bold cursor-pointer transition-colors">Ver todo {'>'}</span>
                       </div>
                       <div className="flex-1 flex flex-col items-center justify-center text-center relative z-10 mt-2">
                          <Package className="w-7 h-7 text-green-500/80 mb-3" />
                          <span className="text-[10px] text-gray-400 font-medium px-4">No hay alertas de inventario. Stock en niveles óptimos.</span>
                       </div>
                    </div>
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 min-h-[140px] flex flex-col">
                       <div className="flex items-center gap-2 mb-6"><PieChart className="w-4 h-4 text-indigo-400" /><span className="text-sm font-bold text-gray-800">Gastos por Categoría</span></div>
                       <div className="flex-1 flex flex-col items-center justify-center text-center mt-2">
                          <CircleDollarSign className="w-7 h-7 text-gray-300 mb-3" />
                          <span className="text-[10px] text-gray-400 font-medium">No hay gastos registrados.</span>
                       </div>
                    </div>
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 min-h-[140px] flex flex-col">
                       <div className="flex items-center gap-2 mb-6"><span className="text-sm font-bold text-gray-800">Actividades Recientes</span></div>
                       <div className="flex-1 flex flex-col items-center justify-center text-center mt-2">
                          <span className="text-[10px] text-gray-400 font-medium mb-4">No hay actividades recientes.</span>
                          <button className="w-full py-2 bg-gray-50 hover:bg-gray-100 transition-colors border border-gray-200 rounded-lg text-[10px] font-bold text-gray-600">Ver Historial Completo {'>'}</button>
                       </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-8 gap-4">
                      <div>
                        <h4 className="text-sm font-bold text-gray-800">Crecimiento: Costos vs Cosechas</h4>
                        <p className="text-[10px] text-gray-400 font-medium mt-1">Análisis comparativo por quintal</p>
                      </div>
                      <div className="flex bg-gray-100 p-0.5 rounded-lg border border-gray-200 shadow-inner self-start">
                        <div className="px-3 py-1.5 text-gray-500 rounded-md text-[9px] font-bold cursor-pointer hover:bg-white hover:shadow-sm">SEMANAL</div>
                        <div className="px-3 py-1.5 bg-[#25523b] text-white rounded-md text-[9px] font-bold shadow-sm">MENSUAL</div>
                      </div>
                    </div>
                    
                    {/* Mock Chart Area */}
                    <div className="relative h-28 sm:h-32 mb-6 border-b border-gray-100 flex items-end">
                      <div className="absolute inset-x-0 bottom-0 flex justify-between px-2 sm:px-8 w-full">
                    ...
                    <div className="flex justify-between text-[8px] sm:text-[9px] font-bold text-gray-400 px-2 sm:px-8 mb-6">
                      <span>ABR</span><span>MAY</span><span>JUN</span><span>JUL</span><span>AGO</span>
                    </div>
                    
                    <div className="flex flex-wrap gap-4 sm:gap-6 mt-4">
                      <div className="flex items-center gap-2"><div className="w-3 sm:w-4 h-2 sm:h-3 bg-green-200 rounded-sm"></div><span className="text-[9px] sm:text-[10px] text-gray-500 font-bold">Costos Acumulados</span></div>
                      <div className="flex items-center gap-2"><div className="w-3 sm:w-4 h-2 sm:h-3 bg-green-500 rounded-sm"></div><span className="text-[9px] sm:text-[10px] text-gray-500 font-bold">Rendimiento de Cosecha (kg)</span></div>
                    </div>
                  </div>
